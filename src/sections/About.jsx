          ...
          <h2 className="text-xl md:text-5xl font-bold leading-tight animate-fade-in animation-delay-100 text-secondary-foreground">
            ...
            <div className="space-y-4 text-muted-foreground animate-fade-in animation-delay-200">
                <p>
                    ...
                    crafting digital products that makes a difference. The journey 
                    started with a curosity for how things work on the inside and it has
                    evolved into a deep expertise in modern frontend technologies.
                </p>
                <p>
                  I specialize in React, Next.js and Python, Building
                  everything from slek landing papers pages to complex
                  enterprise applications. My approach combines technical 
                  excellence with a keen eye for design and user experience.  
                </p>
                <p>
                    When I'm not coding, you wwil find me exploring new technologies 
            ...
            <div className="glass rounded-2xl p-6 glow-border animate-fade-in animation-delay-300">
                <p className="text-lg font-medium italic text-foreground">
                    ...
                    just functional, but truly delightful - products 
                    that users loves to use and developers love to maintain.
                </p>
            </div>
          </div>
